...
import com.airbnb.images.UserPicture;
...
public class ListingActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            Log.d(ListingActivity.class.getSimpleName(), "Failed to get intent data, result code is " + resultCode);
        }
    }
    ...
    private class DataLongOperationAsynchTask extends AsyncTask<String, Void, String[]> {
        ProgressDialog dialog = new ProgressDialog(ListingActivity.this);
        @Override
